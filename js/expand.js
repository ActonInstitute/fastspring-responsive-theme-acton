...
$.fn.expandAll = function(options) {
    ...
    return this.each(function(index) {
       ...
       (o.switchPosition == 'before') ? ($.fn.findSibling = $.fn.prev, $.fn.insrt = $.fn.before) : ($.fn.findSibling = $.fn.next, $.fn.insrt = $.fn.after);
        ...
        $tr = (o.trigger) ? $$.closest(container).find(o.trigger + ' > a') : $$.closest(container).find('.store-product-option-group-title > a');
...
$.fn.expandAll.defaults = {
        ...
        ref : '.store-product-option-group-title', // the switch 'Expand All/Collapse All' is inserted in regards to the element specified by 'ref'
...
$.fn.toggler.defaults = {
     cllpsEl : 'div.store-product-option-group-body',
     method : 'slideToggle',
     speed : 'slow',
     container : '', //the common container of all groups with collapsible content (optional)
     initShow : '' //the initially expanded sections (optional)
};
/* ---------------------------------------------
